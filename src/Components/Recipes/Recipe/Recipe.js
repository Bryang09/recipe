...
class Recipe extends Component {
  ...
  componentDidMount = async () => {
    ...
    axios.get(`https://cors-anywhere.herokuapp.com/http://food2fork.com/api/search?key=${API_KEY}&q=${title}`)
      ...
      <div className="Recipe NoOverflow">
        {
          ...
          <div className="Recipe_Contain">
            ...
            <div className="Recipe_Container">
              <h4> Publisher: <span className="Recipe_Publisher">{this.state.activeRecipe.publisher}</span></h4>
              <h4> Website: <span className="Website" ><a href={this.state.activeRecipe.source_url} target="_blank" >{this.state.activeRecipe.source_url}</a></span></h4>
            </div>
